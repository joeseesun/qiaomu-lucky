...
![Qiaomu Lucky admin modal](docs/assets/admin-modal-1200x680.png)
...
- 多活动管理：创建、暂停、编辑和删除不同抽奖活动。
- 奖品类型：为不同奖项配置名称、颜色、权重和说明。
- 奖品码管理：批量导入奖品码，中奖后自动标记为已发放。
- 抽奖限制：支持手机号、IP、冷却时间和组合限制。
- 中奖查询：用户可以通过手机号查询中奖结果。
- 管理后台：统计卡、中奖记录、奖品码列表、导出记录。
